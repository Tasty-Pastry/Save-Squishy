...
public class BigBossBark extends MapObject{
...
private boolean remove;
	...
	public BigBossBark(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/BossBark.png"));
			
			// Sets the length of the array (Amount of frames)
			sprites = new BufferedImage[30];
