...
public class DeathTransitionStart extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public DeathTransitionStart(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Player/DeathScreenTransition.png"));
		...
		animation.setDelay(30); // Sets the delay in between sprites
