...
public class DogFootHurt extends MapObject{
...
private boolean remove;
	...
	public DogFootHurt(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/DogFootHurt.png"));
