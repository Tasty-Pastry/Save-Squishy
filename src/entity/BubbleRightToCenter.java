...
public class BubbleRightToCenter extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public BubbleRightToCenter(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/Bubble Right to Center.png"));
