...
public class BigBossEntrance extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public BigBossEntrance(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/BigBossEntrance.png"));
			
			// Sets the length of the array (Amount of frames)
			sprites = new BufferedImage[45];
