...
public class DeathTransitionEnd extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public DeathTransitionEnd(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Player/DeathScreenTransitionEnd.png"));
