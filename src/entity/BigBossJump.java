...
public class BigBossJump extends MapObject{
...
private boolean remove;
	...
	public BigBossJump(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/BigBossJump.png"));
