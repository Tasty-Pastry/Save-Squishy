...
public class BubbleRight extends MapObject{
...
private boolean remove;
	...
	public BubbleRight(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/Bubble Right.png"));
