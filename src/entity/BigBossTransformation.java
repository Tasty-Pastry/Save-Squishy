...
public class BigBossTransformation extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public BigBossTransformation(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/BossTransformation.png"));
			
			// Sets the length of the array (Amount of frames)
			sprites = new BufferedImage[42];
