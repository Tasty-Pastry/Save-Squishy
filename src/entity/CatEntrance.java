...
public class CatEntrance extends MapObject{
...
private boolean remove;
	...
	public CatEntrance(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Player/CatEntrance4.png"));
