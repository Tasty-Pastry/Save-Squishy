...
public class BubbleLeftToCenter extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public BubbleLeftToCenter(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/Bubble Left to Center.png"));
