...
private boolean remove;
	...
	public Entrance(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Player/Entrance2.png"));
		...
		animation.setDelay(55); // Sets the delay in between sprites
