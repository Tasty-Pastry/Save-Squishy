...
public class DogFoot extends MapObject{
...
private boolean remove;
	...
	public DogFoot(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/DogFoot.png"));
			
			// Sets the length of the array (Amount of frames)
			sprites = new BufferedImage[78];
