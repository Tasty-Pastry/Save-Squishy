...
public class BubbleLeftToRight extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public BubbleLeftToRight(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/Bubble Left to Right.png"));
