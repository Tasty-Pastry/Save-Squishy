...
public class BubbleRightToLeft extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public BubbleRightToLeft(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/Bubble Right To Left.png"));
