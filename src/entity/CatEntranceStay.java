...
public class CatEntranceStay extends MapObject{
...
private boolean remove;
	...
	// Constructor
	public CatEntranceStay(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Player/CatEntranceStay.png"));
		...
		animation.setDelay(70); // Sets the delay in between sprites
